...
def classify():
    ...
    to_scale = ["age", "annualIncome", "delayFromDueDate", "numDelayedPayment", "numCreditInquiries",
                "outstandingDebt", "totalEMI", "paymentBehaviour_val", "creditAgeYears"]
    ...
    loaded_pipeline = joblib.load('./Model/path_to_your_pipeline.pkl')
